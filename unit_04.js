...
function f5() {
	let out = document.querySelector('.out-5');
		if(document.querySelector('.i-5').checked){
			out.innerHTML = document.querySelector('.i-5').value + ' checkbox';
		}else{
			out.innerHTML = false;
		}
}
...
function f6() {
	let out = document.querySelector('.out-6');
		out.innerHTML = document.querySelector('.i-6').value;
}
...
function f7() {
	...
	let doc = document.querySelector('.i-7');
		out.innerHTML = doc.value;
...
function f8() {
    ...
    //    вашасозданнаякнопка.onclick = f81;
    	let out8 = document.querySelector('.out-8');
	 	out8.innerHTML = '<input class = "i-81"></input> <button class = "b-81"></button>'
...
function f9() {
	let out = document.querySelector('.out-9');
		if(document.querySelector('.r-9').checked){
...
function f14() {
	document.querySelector('.out-14').textContent = document.querySelector('.t-14').value;
}
...
function f16() {
	...
	document.querySelector('.out-16').innerHTML = select;
}
