...
function t6() {
let i = 0
let k = document.querySelector('.i-6').value;
	while(i < k){
		i++
...
function t8() {
	...
	let i2 = document.querySelector('.i-82').value;
		while(i1 <= i2){
			document.querySelector('.out-8').innerHTML += i1 + ' ';
			i1++
		}
...
function t11() {
	let k = document.querySelectorAll('.div-11')
	let i = 0;
		while(i < k.length){
			document.querySelector('.out-11').innerHTML += k[i].textContent + ' ';
			i++
		}
}
...
function t12() {
	let k = document.querySelectorAll('.div-12')
	let i = 0
		while( i <= k.length){
			k[i].style.background = 'orange';
			i++
		}
}
...
function t13() {
	let i = 1;
	let k = document.querySelectorAll('.i-13');
		while( i <= k.length){
			i++;
			k[0].value = '1';
			k[1].value = '2';
...
function t14() {
	let k = document.querySelectorAll('.i-14');
	let i = 0;
			while(i < k.length){
				if(k[i].checked){
				document.querySelector('.out-14').textContent = k[i].value;
				}
				i++
			}
}
