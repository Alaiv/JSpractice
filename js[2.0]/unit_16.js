...
function f3() {
let smth = document.getElementsByClassName("out-3");
for(let things of smth) {
    things.innerHTML = 3
}
}
...
function f4() {
    let smth = document.querySelectorAll(".out-4");
    for(let boi of smth) {
        boi.innerHTML = 4;
    }
}
...
function f11() {
    for(let more in a11) {
        if(a11[more] > 10) {
            document.querySelector(".out-11").innerHTML += a11[more] + ' ';
        }
    }
...
function f12() {
    for(let nums of a12) {
        document.querySelector(".out-12").innerHTML += nums + ' ';
    }
}
...
function f13() {
    for(let char of a13) {
        document.querySelector(".out-13").innerHTML += char + " ";
    }
...
function f14() {
    for(let num of a14) {
        document.querySelector(".out-14").innerHTML += num + " ";
    }
}
...
function f15() {
    let nodes = document.querySelectorAll(".out-15");
    for(let change of nodes) {
        change.innerHTML = 15
    }
}
