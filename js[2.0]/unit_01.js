...
//document.querySelector('.three').innerHTML = '<h3>lorem</h3>';
...
//document.querySelector('.four').innerHTML += '<h4>Привет <p>всем</p> ребятам</h4>';
...
let z1 = 6;
let z2 = 3;
document.querySelector('.mine').innerHTML = z1 * z2;
// Task 15.
...
document.querySelector('.zero').innerHTML = x1 + x2;
