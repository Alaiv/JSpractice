...
function f4() {
    let stuff = document.querySelector(".i-4").value;
    d1.push(stuff);
    showArr('.out-4', d1);
}
...
function f5() {
    let stuff = document.querySelector(".i-5").value;
    d1.unshift(stuff);
    showArr('.out-5', d1);
}
...
function f6() {
    let stuff = document.querySelector(".i-6").value;
    d6[d6.length] = stuff;
...
function f8() {
    let stuff = document.querySelector(".i-8").value;
    d8.splice(0,0 , stuff);
    showArr('.out-8', d8);
}
...
function f11() {
    let stuff = +document.querySelector(".i-11").value;
    if(d11.indexOf(stuff) === -1){
        document.querySelector(".out-11").innerHTML = "-1";
    } else{
        document.querySelector(".out-11").innerHTML = d11.indexOf(stuff);
    }
}
...
function f12() {
    let out = "";
    let stuff = +document.querySelector(".i-12").value;
...
function f14() {
    let stuff = +document.querySelector(".i-14").value;
...
function f15() {
    let stuff = +document.querySelector(".i-15").value;
    if(d15.includes(stuff)){
...
function f17() {
    ...
    document.querySelector(".out-17").innerHTML = d17;
    showArr('.out-17', d17);
}
...
function f18() {
    let stuff = document.querySelector(".i-18").value;
    let boi = d18.includes(stuff);
    document.querySelector(".out-18").innerHTML = boi;
...
let d19 = ['payment', 'method', 'will', 'automatically', 'be', 'charged', 'in', 'advance', 'every'];
let maxString = '';

function f19() {
    let length = 0;
    for(let j = 0; j < d19.length; j++){
        if(d19[j].length > length) {
            length = d19[j].length;
           maxString = d19[j];
        }
    }
...
function f20() {
    let yo = d20.join('');
    document.querySelector(".out-20").innerHTML = yo;
}
