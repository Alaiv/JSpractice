...
let ar1 = [1, "Hello", true, false, "Got it", 25]
function f1() {
...
let ar4 = [1, 2, 3 ,5, "eqw", true, 22, 22, 44, 31, "yoyoy"]
function f4() {
    console.log(ar4[0] + " " + ar4[3] + " " + ar4[8]);
...
let ar6 = ["Александр ", " Лев ", 1995, " Август"]
...
function f7() {
    ...
    ar7[7] = 'vietnam';
    let qwe = ar7.join(" ");
    document.querySelector(".out-7").innerHTML = qwe;
}
...
let ar9 = [100, 200, 300, 400, 700];

function f9() {
    let last = ar9.length - 1;
    document.querySelector(".out-9").innerHTML = ar9[last];
}
...
let ar12 = ['test', 'west', 'list', 'class'];

function f12() {
    let zero = ar12[0];
    ar12[0] = ar12[ar12.length - 1];
    ar12[ar12.length - 1] = zero;
    let result = ar12.join(" ")
...
function f13() {
    for(let i = 0; i < ar13.length; i++){
        document.querySelector(".out-13").innerHTML += i + " " + ar13[i] + " ";
    }
}
...
function f14() {
    // let result = ar14.join(" ")
    for(let i = ar14.length - 1; i >= 0; i--){
        document.querySelector(".out-14").innerHTML += ar14[i] + " ";
    }
...
let ar15 = [0, 2, 5, -4, 6, 22, -9, -12, 8, 12, 13, 78, 122, -3];

function f15() {
    for(let i = 0; i < ar15.length; i++){
        if(ar15[i] > 0){
            document.querySelector(".out-15").innerHTML += ar15[i] + " ";
        }
    }
...
let ar16 = [0, 2, 5, -4, 6, 22, -9, -12, 8, 12, 13, 78, 10, 71];
let ar16_odd = [];
let ar16_even = [];
...
function f16() {
    for(let i = 0; i < ar16.length; i++){
        if(ar16[i] % 2 !== 0){
            ar16_odd[i] = ar16[i];
            document.querySelector(".out-16-odd").innerHTML += ar16_odd[i] + " ";
        } else if (ar16[i] % 2 == 0) {
            ar16_even[i] = ar16[i];
            document.querySelector(".out-16-even").innerHTML += ar16_even[i] + " ";
        }
    }
...
function f17() {
    for(let i = 0; i < ar17.length; i++){
        if(ar17[i] > 3){
            document.querySelector(".out-17").innerHTML += ar17[i] + " ";
        }
    }
...
let ar18 = [15, 24, 13, 78, 21, 4, 45, 67, 220  ];
...
let ar19 = [15, 424, 313, 78, 241, 4, 45, 67, 2];
