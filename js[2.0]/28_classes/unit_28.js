 ...
 let goods = new Goods("Cheese", 2, "img****", 25, ".out-3");
 goods.draw()
 //Task 2.
...
// let goods2 = new Goods("Burgers", 4, "img*123", "125", ".out-4");
//  goods2.draw()
 ...
 let goods3 = new Goods2("yo", 5, "img", 123, ".out-5");
 goods3.draw();
 ...
 // Создайте объект на основе класса Valid и задайте ему имя и пароль длиной 5 символов. Запустите метод validate() и выведите в консоль свойство isValid.
  let user = new Valid("Username", "qwqw");
  user.validate();
 ...
 let user2 = new Valid("Username", "qwqweeqweqwr");
 user2.validate();
